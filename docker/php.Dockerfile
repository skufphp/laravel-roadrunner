...
# ==============================================================================
# Базовая среда PHP с RoadRunner — используется для разработки и как основа для продакшена
# ==============================================================================
...
# 5) Конфигурация php.ini (dev по умолчанию, prod переопределяется в production stage)
COPY docker/php/php.ini /usr/local/etc/php/conf.d/local.ini

# 6) Установка Composer
COPY --from=composer:latest /usr/bin/composer /usr/bin/composer

# 7) Установка RoadRunner
